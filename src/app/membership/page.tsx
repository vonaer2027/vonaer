          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {membershipTiers.map((tier, index) => (
              ...
              >
                ...
                <Card className={`border shadow-lg hover:shadow-xl transition-all duration-300 h-full bg-gradient-to-br from-card to-card/80 ${tier.popular ? 'ring-2 ring-primary' : ''}`}>
