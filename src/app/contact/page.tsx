                ...
                <div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="p-4 rounded-lg bg-background/50 hover:bg-background/70 transition-colors">
                      <h3 className="text-lg font-bold text-foreground mb-1">{t('email')}</h3>
                      <a
                    ...
                    {/* Social Media */}
                    <div className="p-4 rounded-lg bg-background/50 hover:bg-background/70 transition-colors">
                      <h3 className="text-lg font-bold text-foreground mb-3">{t('social')}</h3>
                      <div className="flex gap-4">
                        ...
                        {/* Instagram Link */}
                        <a
                          href="https://www.instagram.com/vonaer.official"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="px-6 py-3 rounded-lg bg-primary hover:bg-primary/90 text-white font-semibold transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                        >
                    ...
                    {/* Phone */}
                    <div className="p-4 rounded-lg bg-background/50 hover:bg-background/70 transition-colors">
                      <h3 className="text-lg font-bold text-foreground mb-1">{t('phone')}</h3>
                      <a
                        href="tel:+8216009064"
                        className="text-base md:text-lg text-primary hover:underline"
                      >
                        +82 1600 9064
                      </a>
                    </div>
