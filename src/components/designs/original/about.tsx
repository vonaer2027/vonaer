      ...
      <div className="container mx-auto px-4">
            ...
            {coreValues.map((value, index) => (
              ...
              >
                <div className="p-8 text-center h-full flex flex-col">
                  <div className="w-16 h-16 rounded-2xl border border-gray-200 bg-gray-50 flex items-center justify-center mx-auto mb-8">
        ...
        >
          <div className="bg-white border border-gray-200 rounded-xl shadow-lg p-12 md:p-16 text-center">
            ...
            <button className="border border-gray-300 bg-gray-50 text-gray-900 hover:bg-gray-100 px-10 py-4 text-lg font-semibold group shadow-lg transition-all duration-300 flex items-center gap-2 mx-auto">
