...
const translations = {
  korean: {
    // Hero section
    "VONAER": "VONAER",
    "A platform proposing a new lifestyle, VONAER is an Urban Air Mobility service.": "전세계를 하나로 잇는 아시아 최초의 럭셔리 에어 모빌리티 플랫폼입니다. 비즈니스 미팅이든 가족 여행이든 — 우리는 ‘당신의 시간을 되돌려 드리는’ 경험을 제공합니다",
    "Book Flight": "항공편 예약",
