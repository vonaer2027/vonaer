        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-7xl md:text-8xl lg:text-9xl font-extralight text-white leading-none mb-8">
              <img src="/vonaer.svg" alt="VONAER" className="h-16 md:h-20 lg:h-24 w-auto" />
            </h1>
          </motion.div>
          ...
          >
            ...
            <div>
              <button
                ...
                className="group px-10 py-4 border border-white text-white hover:bg-white hover:text-black transition-all duration-300 flex items-center justify-center gap-2"
              >
                {t('hero.bookFlight')}
