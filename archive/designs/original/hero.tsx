      ...
      <div className="relative z-20 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-light text-white mb-8 leading-tight tracking-wide">
            <img src="/vonaer.svg" alt="VONAER" className="h-10 md:h-12 lg:h-14 w-auto mx-auto" />
          </h1>
          ...
          <button
            ...
            className="bg-white text-black hover:bg-gray-100 transition-all duration-300 px-16 py-6 text-xl font-semibold tracking-wide group shadow-2xl border-2 border-white hover:border-gray-200 hover:shadow-3xl transform hover:scale-105 flex items-center justify-center gap-2 mx-auto"
          >
            {t('hero.bookFlight')}
